  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      <input
        ...
        style={{ width: '100px', backgroundColor:'lightgreen', padding: '15px', }}
        autoComplete='name'
        required
      />
        <br></br>
...
<br></br>
      ...
      <br></br>
      <label htmlFor="confirmPassword" color=''>Confirm Password:</label>
      <br></br>
      <input
        type="password"
        id="confirmPassword"
      ...
      <br></br>
      <br></br>
      <button style={{backgroundColor: 'skyblue', padding:'15px', width:'100px'}} type="submit" onClick={handleSubmit}>Submit</button>
